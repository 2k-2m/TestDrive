...
#archivo_csv = f"C:/Users/Viva/3D Objects/Facebook_Data_{timestamp}.csv"
#archivo_csv = f" /media/pi/P_VAST/Facebook_Data_{timestamp}.csv"
archivo_csv = f"/home/pi/Desktop/Testdrive/data/Facebook_Data_{timestamp}.csv"

file_exists = os.path.isfile(archivo_csv)

encabezados = ["App",  "Red", "Type of test", "Latitude", "Longitude", "Initial Time",
    "Final Time", "State", "Cause of failure", "Content Size (MB)"]
...
def test_login_facebook():
    ...
    try:
        ...
        while not detener:
            ...
            try:
                    ...
                    if photos:
                        ...
                        latitude_story, longitude_story, _ = obtener_ubicacion(udid)
                    ...
                    try:
                        ...
                        if click_si_existe(driver, AppiumBy.ANDROID_UIAUTOMATOR,
                            ...
                            if red_msg == "Disconnected":
                                ...
                                latitude_msg, longitude_msg,_ = obtener_ubicacion(udid)
                                resultado = "Failed"
                                falla = "No service"
                    ...
                    try:
                        ...
                        if click_si_existe(driver, AppiumBy.ANDROID_UIAUTOMATOR,
                            ...
                            if red_photo == "Disconnected":
                                ...
                                latitude_photo, longitude_photo,_ = obtener_ubicacion(udid)
                                resultado = "Failed"
                                falla = "No service"
                                tamanio = "0.0"
                    ...
                    try:
                        ...
                        if click_si_existe(driver, AppiumBy.XPATH,
                            ...
                            latitude_video, longitude_video,_ = obtener_ubicacion(udid)
                    ...
                    try:
                        ...
                        if click_en_primer_archivo_disponible(driver):
                            ...
                            if red_file == "Disconnected":
                                ...
                                latitude_file, longitude_file,_ = obtener_ubicacion(udid)
                                resultado = "Failed"
                                falla = "No service"
                                tamanio = "0.0"
                ...
                print("\n[INFO] Interrupción por teclado (Ctrl+C) capturada.")
        ...
        print(f"[ERROR] Excepción general en test_login_facebook: {e}")
    finally:
        try:
            cerrar_todas_las_apps(["com.facebook.katana", "com.facebook.orca"], udid)
            driver.quit()
