...
def test_instagram():
    ...
    if click_tab_icon(driver, "com.instagram.android:id/tab_icon", 3, "Crear", 5) and asegurar_publicacion_activa(driver):
...
def ejecutar_pruebas(n=1):
    resultado = subprocess.run(
        ["adb", "-s", "R58M795NHZF", "shell", "appops", "get", "com.instagram.android"],
        capture_output=True, text=True
    )
    print("[INFO] Permisos de com.instagram.android:")
